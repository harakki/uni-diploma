...
public class AnalyticsEventListener {
    ...
    @Async
    @ApplicationModuleListener
    public void on(TitleAddedToCollectionEvent event) {
        ...
        try {
            analyticsService.recordTitleAddedToCollection(event);
    ...
    @Async
    @ApplicationModuleListener
    public void on(TitleRemovedFromCollectionEvent event) {
        log.debug("Processing title removed from collection event: collectionId={}, titleId={}, userId={}",
                event.collectionId(), event.titleId(), event.userId());

        try {
            analyticsService.recordTitleRemovedFromCollection(event);
